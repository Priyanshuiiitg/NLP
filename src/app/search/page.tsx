  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setResult(result.prediction); // Set "Fake" or "Not Fake" message
                ...
                <>
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-600 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                      {/* <span className="flex select-none items-center pl-3 text-gray-400 sm:text-sm">http://</span> */}
                      <input
                        id="website"
                        name="website"
                        type="text"
                ...
                <>
                  ...
                  <div className="mt-2">
                    <textarea
                      ...
                      value={text}
                      onChange={handleInputChange}
                      className="block w-full rounded-md border-0 py-1.5 text-white shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
      ...
      {showModal && (
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded shadow-lg max-w-md w-full">
            ...
            <p className={`text-center text-2xl font-bold ${result === 'Not Fake' ? 'text-green-600' : 'text-red-600'}`}>
  {result === 'Not Fake' ? '🟢 This news is Not Fake' : '🔴 This news is Fake'}
</p>
